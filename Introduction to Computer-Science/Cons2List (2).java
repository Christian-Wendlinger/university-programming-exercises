//Cons2Liste nach dem Stand von Blatt 12 + Methode zum finden des kleinsten Wertes in der Liste
//Onur, Christian
...
public class Cons2List {
  ...
  //kleinsten Wert für eine Liste von Integern ausgeben
  public int findMin() {
	  return findMin(this.head, (int) this.head.obj);
  }

  private int findMin(Cons2 cons, int min) {
	  ...
	  //kleinere Zahl gefunden
	  if((int) cons.obj < min) {
		  min = (int) cons.obj;
	  }

	  //rekursiver Aufruf
	  return findMin(cons.next, min);
  }
}
